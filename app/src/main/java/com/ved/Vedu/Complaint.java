...
public class Complaint extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uploadName = findViewById(R.id.signup_name);
        uploadEmail= findViewById(R.id.email1);
        uploadNumber= findViewById(R.id.phonen);
        uploadAdd = findViewById(R.id.signup_com);
        uploadImage = findViewById(R.id.image11);
    ...
    public void uploadData(){
        ...
        FirebaseDatabase.getInstance().getReference("Complaint List").child(currentDate)
                .setValue(dataClass).addOnCompleteListener(task -> {
                    ...
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Complaint.this, e.getMessage().toString(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
}